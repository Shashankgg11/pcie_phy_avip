...
//--------------------------------------------------------------------------------------------
// Class: pcie_phy_ep_agent_config
// Used as the configuration class for pcie_phy ep agent (Upstream Port (Endpoint)), configures rate/width capability and coverage enable
//--------------------------------------------------------------------------------------------
