...
// Driver proxy for the Endpoint (Upstream Port).
// Gets pcie_phy_ep_tx items from the sequencer and sends them to the EP driver BFM.
//-------------------------------------------------------------------------------------------- 
  ...
  forever begin 
    ...
    1'b0 
      ...
      case (req.task_id) 
        ...
        LTSSM_TASK_L0: begin 
          //Run L0 in the background. It keeps running during normal operation.
          //Reaching L0 means the state was entered successfully.
